...
class HabilitacionesView extends StatefulWidget {
  const HabilitacionesView({Key? key}) : super(key: key);

  @override
  State<HabilitacionesView> createState() => _HabilitacionesViewState();
}

class _HabilitacionesViewState extends State<HabilitacionesView> {
    ...
    return Container(
      child: Center(
        child: ListView(
          ...
          children: [
            Text(
              'Habilitaciones-Inhabilitaciones',
