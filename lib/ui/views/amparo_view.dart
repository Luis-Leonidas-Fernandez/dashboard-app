...
class AmparoView extends StatefulWidget {
  const AmparoView({Key? key}) : super(key: key);

  @override
  State<AmparoView> createState() => _AmparoViewState();
}

class _AmparoViewState extends State<AmparoView> {
