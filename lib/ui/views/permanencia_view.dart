...
class PermanenciaView extends StatefulWidget {
  const PermanenciaView({Key? key}) : super(key: key);

  @override
  State<PermanenciaView> createState() => _PermanenciaViewState();
}

class _PermanenciaViewState extends State<PermanenciaView> {
