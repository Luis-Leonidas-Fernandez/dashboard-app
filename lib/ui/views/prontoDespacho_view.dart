...
class ProntoDespachoView extends StatefulWidget {
  const ProntoDespachoView({Key? key}) : super(key: key);

  @override
  State<ProntoDespachoView> createState() => _ProntoDespachoViewState();
}

class _ProntoDespachoViewState extends State<ProntoDespachoView> {
