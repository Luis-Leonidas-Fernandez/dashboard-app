...
class ReservaVacanteView extends StatefulWidget {
  const ReservaVacanteView({Key? key}) : super(key: key);

  @override
  State<ReservaVacanteView> createState() => _ReservaVacanteViewState();
}

class _ReservaVacanteViewState extends State<ReservaVacanteView> {
