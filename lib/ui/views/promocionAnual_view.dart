...
class PromocionAnualView extends StatefulWidget {
  const PromocionAnualView({Key? key}) : super(key: key);

  @override
  State<PromocionAnualView> createState() => _PromocionAnualViewState();
}

class _PromocionAnualViewState extends State<PromocionAnualView> {
