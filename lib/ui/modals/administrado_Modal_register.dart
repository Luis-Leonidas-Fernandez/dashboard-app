...
class AdministradoModalRegister extends StatefulWidget {
  final Administrado? administrado;

  AdministradoModalRegister({Key? key, this.administrado}) : super(key: key);

  @override
  State<AdministradoModalRegister> createState() =>
      _AdministradoModalRegisterState();
}

class _AdministradoModalRegisterState extends State<AdministradoModalRegister> {
